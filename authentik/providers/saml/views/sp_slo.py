...
class SPInitiatedSLOBindingRedirectView(SPInitiatedSLOView):
    ...
    def dispatch(self, request: HttpRequest, *args, **kwargs) -> HttpResponse:
        ...
        # If we receive a logoutResponse, this means we are using redirect based
        ...
        if REQUEST_KEY_SAML_RESPONSE in request.GET:
            ...
            if relay_state:
                # Try to decode base64 relay state
                try:
...
class SPInitiatedSLOBindingPOSTView(SPInitiatedSLOView):
    ...
    def dispatch(self, request: HttpRequest, *args, **kwargs) -> HttpResponse:
        ...
        # Default behavior before we checked for SAML Response
        return super().dispatch(request, *args, **kwargs)
